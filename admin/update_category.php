    ...
    <div class="container px-4">
      <div class="card mt-3 mb-4">
        <div class="card-header">
           <i class="fas fa-table me-1 mr-1"></i>Update Category
        </div>
      <div class="card-body px-4">
      	<?php
            ...
            $id = $_POST['id'];
					  ...
					  $sql = 'update categories set Category = ? where CatID = ?';
        ...
        ?>
          ...
          <input type="hidden" class="form-control" id="id" value="<?php echo $id?>"  name="id">
			    ...
			    <div class="form-group">
			    	<button type="submit" name="submit" class="btn btn-sm btn-primary">Update</button>&nbsp;<a href="categories.php" class="btn btn-sm btn-dark" role="button">Back</a>
			  	</div>
			  </form>
